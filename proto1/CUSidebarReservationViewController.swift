//
//  CUSidebarReservationViewController.swift
//  CurlUpMobileIOS
//
...
@objc(CUSidebarReservationViewController) class CUSidebarReservationViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, SWRevealViewControllerDelegate
{
    @IBOutlet weak var tableView: UITableView!
    @IBOutlet weak var searchBar: UISearchBar!
    
    @IBOutlet weak var loadingView: UIView!
    @IBOutlet weak var loadingReservationsLabel: UILabel!
    ...
    var model = CUReservationViewModel()
    ...
    override func viewDidLoad()
    {
        ...
        let rightNavigationBarButton = UIBarButtonItem(title: "Edit", style: UIBarButtonItemStyle.Plain, target: self, action: Selector("editReservations:"))
    ...
    override func viewWillAppear(animated: Bool)
    {
        ...
        if self.model.reservationCollection.count == 0
        {
            self.loadingReservationsLabel.hidden = false
            ...
            {
                self.loadingReservationsLabel.hidden = true
                ...
                for var i = 0; i < CUSalonCollection.sharedInstance.salons.count; ++i
                {
                    ...
                    var history = CUReservationCell(reservationTitle: "", salonDefaultImage: UIImage(), reservationDateTime: NSDate(), reservationTimeString: "", reservationDateString: "", salonAddress: "", designerName: "")
                    // Set struct 
                    ...
                    self.model.reservationCollection.append(history)
                }
    ...
    func editReservations(sender: AnyObject)
    {
        if (self.model.reservationCollection.count == 0) { return }    // If we don't have any salons in our history, don't toggle edit mode
    ...
    func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath)
    {
        ...
        self.model.reservationCollection.removeAtIndex(indexPath.row)
    ...
    {
        return self.model.reservationCollection.count
    }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        let salon = self.model.reservationCollection[i]
